        ...
        <nav className="iqac-navbar">
            <div className="iqac-nav-section">
                ...
                <ul className="iqac-nav-items">
                    ...
                    <li><NavLink to="/iqac/hierarchy" className={({ isActive }) => `iqac-nav-link ${isActive ? 'active' : ''}`}><FontAwesomeIcon icon={faSitemap} className="iqac-nav-icon" /> Organization</NavLink></li>
                </ul>
            </div>
            ...
            <div className="iqac-nav-section">
                ...
                <ul className="iqac-nav-items">
                    <li><NavLink to="/iqac/meetings" className={({ isActive }) => `iqac-nav-link ${isActive ? 'active' : ''}`}><FontAwesomeIcon icon={faHistory} className="iqac-nav-icon" /> Minutes</NavLink></li>
                    <li><NavLink to="/iqac/audit" className={({ isActive }) => `iqac-nav-link ${isActive ? 'active' : ''}`}><FontAwesomeIcon icon={faCalculator} className="iqac-nav-icon" /> Audit</NavLink></li>
            ...
            <div className="iqac-nav-section">
                ...
                <ul className="iqac-nav-items">
                    <li><NavLink to="/iqac/downloads" className={({ isActive }) => `iqac-nav-link ${isActive ? 'active' : ''}`}><FontAwesomeIcon icon={faDownload} className="iqac-nav-icon" /> Downloads</NavLink></li>
                    <li>
