...
const phDProgrammes = [
  ...
  { sno: 9, name: "Mechatronics Engineering", route: "mechatronics" },
  { sno: 10, name: "Food Technology", route: "food_technology" },
  { sno: 11, name: "Master of Business Administration", route: "mba" },
  { sno: 12, name: "Master of Computer Applications", route: "mca" },
  { sno: 13, name: "Automobile Engineering", route: "automobile" },
