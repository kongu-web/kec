...
import Deptimg from "../../../assets/images/Department Banner/foodtech.webp";
import Depthomeimg from "../../../assets/images/Department Banner/foodtech_home.webp";
          ...
          {activeSection === "Home" && autoData && (
            <div className="auto-content">
              ...
              <div className="dept-stats-grid">
                ...
                <div className="dept-stat-card">
                  <div className="stat-label">M.E / Post Graduate</div>
                ...
                {facultyData.map((faculty, index) => (
                  ...
                  >
                    <div className="faculty-photo">
                      <img
                        src={require(`../../../assets/images/faculty_images/foodtech/${faculty.image}`)}
