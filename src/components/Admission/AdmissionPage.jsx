...
const AdmissionPage = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "Placements are excellent. For the academic year 2025-26, we have already secured 1810+ offers with a highest package of 61.21 LPA. In the academic year 2024-25, we achieved 1693 offers with a highest package of 61.21 LPA.",
    },
    {
