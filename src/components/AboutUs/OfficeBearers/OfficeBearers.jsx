    ...
    <>
      ...
      <div className="office-intro">
        ...
        <div className="office-grid">
          <div className="office-card"><strong>THIRU. C. DEVARAJAN, B.E.</strong><br />PRESIDENT</div>
          ...
          <div className="office-card"><strong>Dr. R. KUMARASWAMY, M.B.B.S.</strong><br />VICE PRESIDENT</div>
           <div className="office-card"><strong>THIRU. KAARTHIK M MURUGESAN, B.E., M.B.A.(UK)</strong><br />VICE PRESIDENT</div>
      ...
      <div className="office-container">
        <div className="office-intro">
          <div className="office-text">
            ...
            <p className="office-description">
              The Kongu Vellalar Institute of Technology Trust" (KVITT), came
              into being on account of the continuous and magnanimous efforts of
              a group of illustrious people from all walks of life during 1983.
              The origin of the term " K O N G U " dates back to putative race
              called " C H E R A " who ruled the south in those days. Thus, the
              word "Kongu Vellalar" refers to a community called Kongu Vellalar
              Gounders, mainly concentrated in and around Erode District. The
              Community "KONGU" as it is called, was pushed to the background,
              owing to the privatisation of facilities in the field of
              education, especially, Technical Education. Hence, this Trust was
              created by a group of philanthropists from Kongu Vellalar Gounders
              to promote technical education and cultural activities and to
              encourage literary and scientific knowledge.
            </p>
          </div>
          <div className="office-image">
            <img src={Kvit} alt="KVIT Building" />
        ...
        <div className="office-grid">
          ...
          <div className="office-card">
            <strong>Dr. M. MANICKAM, M.Sc., M.B.A.</strong>
            <br />
            VICE PRESIDENT
          </div>
          <div className="office-card">
            <strong>THIRU. A. VENKATACHALAM, B.Sc.</strong>
            <br />
            VICE PRESIDENT
          </div>
          <div className="office-card">
            <strong>THIRU. A. K. ILANGO, B.Com., M.B.A., LLB.</strong>
            <br />
            VICE PRESIDENT
          </div>
          <div className="office-card">
            <strong>Dr. R. KUMARASWAMY, M.B.B.S.</strong>
            <br />
            VICE PRESIDENT
          </div>
          <div className="office-card">
            <strong>THIRU. R. R. SATHIYAMURTHI, B.Arch., M.S.</strong>
            <br />
            SECRETARY
          </div>
          <div className="office-card">
            <strong>THIRU. P. D. THANGAVEL, B.B.M.</strong>
            <br />
            JOINT SECRETARY
          </div>
          <div className="office-card">
            <strong>THIRU. R. BALAKRISHNAN, D.M.E.</strong>
            <br />
            JOINT SECRETARY
          </div>
          <div className="office-card">
            <strong>THIRU. E.R.KAARTHIKEYAN, M.A.</strong>
            <br />
            TREASURER
          </div>
          <div className="office-card">
            <strong>THIRU. E. R. K. KRISHNAN, M.Com.</strong>
            <br />
            CORRESPONDENT / KEC{" "}
          </div>
          <div className="office-card">
            <strong>THIRU. K. KARTHIKEYAN, B.Sc.,MOM(Aus).</strong>
            <br />
            CORRESPONDENT / KPC, KPITI & KNYMCH
          </div>
          <div className="office-card">
            <strong>THIRU. P. SACHITHANANDAN</strong>
            <br />
            CORRESPONDENT / KASC
          </div>
          <div className="office-card">
            <strong>Dr. K. SENGOTTUVELAN, M.B.B.S., D.C.H.</strong>
            <br />
            CORRESPONDENT / KNMHSS
          </div>
          <div className="office-card">
            <strong>THIRU. A. K. C. THIYAGARAJAN</strong>
            <br />
            LIFE MEMBER
          </div>
